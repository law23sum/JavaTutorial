package packagee.classs.statement;

public class IfElseIfSwitchConditionals {
    ...
    static String searchMe = "peter piper picked a " + "peck of pickled peppers", searchMeToo = "Look for a substring in me", substring = "sub";
    ...
    static int searchfor = 12, i, j, max = searchMe.length(), numPs = 0, maxy = searchMeToo.length() - substring.length();
